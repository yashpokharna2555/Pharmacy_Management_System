...
if (isset($_POST['submit'])) {
    ...
    $sql1 = mysqli_query($conn, "SELECT * FROM manager WHERE username='$user'") or die(mysqli_error($conn));
...
<hr/>	
    <div class="tabbed_area">  
		...
		*/
        ...
        $result = mysqli_query($conn, "SELECT * FROM manager") or die(mysqli_error($conn));

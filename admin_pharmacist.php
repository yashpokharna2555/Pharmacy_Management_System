...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1 = mysqli_query($conn, "SELECT * FROM pharmacist WHERE username='$user'") or die(mysqli_error($conn));
...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($conn, "SELECT * FROM pharmacist") or die(mysqli_error($conn));
...
<div id="footer" align="Center"> Code With Yash - Pharmacy Management System</div>
</div>
</body>
</html>
